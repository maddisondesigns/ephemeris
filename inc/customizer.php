...
class ephemeris_initialise_customizer_settings {
	...
	public function ephemeris_register_social_controls( $wp_customize ) {
		...
		$socialIconsList = array(
			'500px' => __( '<i class="fa-brands fa-500px"></i>', 'ephemeris' ),
			'ArtStation' => __( '<i class="fa-brands fa-artstation"></i>', 'ephemeris' ),
			'Behance' => __( '<i class="fa-brands fa-behance"></i>', 'ephemeris' ),
			'BiliBili' => __( '<i class="fa-brands fa-bilibili"></i>', 'ephemeris' ),
			'Bitbucket' => __( '<i class="fa-brands fa-bitbucket"></i>', 'ephemeris' ),
			'Bluesky' => __( '<i class="fa-brands fa-bluesky"></i>', 'ephemeris' ),
			'CodePen' => __( '<i class="fa-brands fa-codepen"></i>', 'ephemeris' ),
			'DeviantArt' => __( '<i class="fa-brands fa-deviantart"></i>', 'ephemeris' ),
			'Discord' => __( '<i class="fa-brands fa-discord"></i>', 'ephemeris' ),
			'Dribbble' => __( '<i class="fa-brands fa-dribbble"></i>', 'ephemeris' ),
			'Etsy' => __( '<i class="fa-brands fa-etsy"></i>', 'ephemeris' ),
			'Facebook' => __( '<i class="fa-brands fa-facebook-f"></i>', 'ephemeris' ),
			'Figma' => __( '<i class="fa-brands fa-figma"></i>', 'ephemeris' ),
			...
			'letterboxd' => __( '<i class="fa-brands fa-letterboxd"></i>', 'ephemeris' ),
			'LinkedIn' => __( '<i class="fa-brands fa-linkedin-in"></i>', 'ephemeris' ),
			'Mastodon' => __( '<i class="fa-brands fa-mastodon"></i>', 'ephemeris' ),
			'Medium' => __( '<i class="fa-brands fa-medium-m"></i>', 'ephemeris' ),
			'Patreon' => __( '<i class="fa-brands fa-patreon"></i>', 'ephemeris' ),
			'Pinterest' => __( '<i class="fa-brands fa-pinterest-p"></i>', 'ephemeris' ),
			'Pixiv' => __( '<i class="fa-brands fa-pixiv"></i>', 'ephemeris' ),
			'Quora' => __( '<i class="fa-brands fa-quora"></i>', 'ephemeris' ),
			'Reddit' => __( '<i class="fa-brands fa-reddit-alien"></i>', 'ephemeris' ),
			'Slack' => __( '<i class="fa-brands fa-slack-hash"></i>', 'ephemeris' ),
			'SlideShare' => __( '<i class="fa-brands fa-slideshare"></i>', 'ephemeris' ),
			'Snapchat' => __( '<i class="fa-brands fa-snapchat-ghost"></i>', 'ephemeris' ),
			'SoundCloud' => __( '<i class="fa-brands fa-soundcloud"></i>', 'ephemeris' ),
			'Spotify' => __( '<i class="fa-brands fa-spotify"></i>', 'ephemeris' ),
			'Stack Overflow' => __( '<i class="fa-brands fa-stack-overflow"></i>', 'ephemeris' ),
			'Steam' => __( '<i class="fa-brands fa-steam"></i>', 'ephemeris' ),
			'Telegram' => __( '<i class="fa-brands fa-telegram"></i>', 'ephemeris' ),
			'Threads' => __( '<i class="fa-brands fa-threads"></i>', 'ephemeris' ),
			'TikTok' => __( '<i class="fa-brands fa-tiktok"></i>', 'ephemeris' ),
			'Tumblr' => __( '<i class="fa-brands fa-tumblr"></i>', 'ephemeris' ),
			'Twitch' => __( '<i class="fa-brands fa-twitch"></i>', 'ephemeris' ),
			'Twitter' => __( '<i class="fa-brands fa-x-twitter"></i>', 'ephemeris' ),
			'Unity' => __( '<i class="fa-brands fa-unity"></i>', 'ephemeris' ),
			'Unsplash' => __( '<i class="fa-brands fa-unsplash"></i>', 'ephemeris' ),
			'Upwork' => __( '<i class="fa-brands fa-upwork"></i>', 'ephemeris' ),
			'Vimeo' => __( '<i class="fa-brands fa-vimeo-v"></i>', 'ephemeris' ),
			'Weibo' => __( '<i class="fa-brands fa-weibo"></i>', 'ephemeris' ),
			'WhatsApp' => __( '<i class="fa-brands fa-whatsapp"></i>', 'ephemeris' ),
			'YouTube' => __( '<i class="fa-brands fa-youtube"></i>', 'ephemeris' ),
		);
